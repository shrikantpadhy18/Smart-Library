# Generated by Django 2.2a1 on 2019-04-04 06:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookname', models.CharField(max_length=130)),
                ('year', models.CharField(default='', max_length=2)),
                ('bookid', models.IntegerField(unique=True, validators=[django.core.validators.MaxValueValidator(9999), django.core.validators.MinValueValidator(9001)])),
                ('publisher', models.TextField()),
            ],
        ),
        migrations.CreateModel(
